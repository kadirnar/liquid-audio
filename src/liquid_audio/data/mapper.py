...
class LFM2AudioChatMapper:
    ...
    def __init__(
        ...
        *,
        ...
        audio_input_transform: Callable[[torch.Tensor, int], torch.Tensor] | None = None,
    ) -> None:
        self.processor = processor
        self.codebooks = codebooks
        self.interleaved_text_tokens = interleaved_text_tokens
        self.interleaved_audio_tokens = interleaved_audio_tokens
        self.audio_input_transform = audio_input_transform
    ...
    def _append_audio_in(
        ...
        *,
        ...
        if self.audio_input_transform is not None:
            wav = self.audio_input_transform(wav, sampling_rate)
